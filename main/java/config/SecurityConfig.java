package com.study.security_jiyun.config;
...
import com.study.security_jiyun.config.auth.AuthFailureHandler;
import com.study.security_jiyun.service.auth.PrincipalOauth2UserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Bean
	public BCryptPasswordEncoder passwordEncoder() { //비밀번호 자동 암호화
