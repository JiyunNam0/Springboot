package com.study.security_jiyun.web.dto.auth;
...
public class SignupReqDto {
	...
	@NotBlank
	@Pattern(regexp = "^[a-zA-Z]{1}[a-zA-Z0-9]{4,12}$") /*첫글자는 무조건 영문이여야함 4개~12개까지*/ 
	private String username;
	@NotBlank
	@Pattern(regexp = "^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[-~!@#$%^&*_+=])[a-zA-Z\\d-~!@#$%^&*_+=]{8,16}$", message = "영문자, 특수문자, 숫자를 모두 포함해야합니다.")
